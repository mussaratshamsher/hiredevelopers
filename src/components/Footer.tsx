...
<div  className='flex flex-col justify-center items-center text-4xl'>
    <h1 className='font-extrabold text-3xl mb-5'>Social links</h1>
...
<h1 className='font-extrabold text-3xl mb-5 md:mt-20'>Newsletter</h1>
...
<button className=' bg-yellow-400 text-white p-3 mt-10 mb-20 m-auto border-2 border-yellow-400 w-56 md:w-[300px] 
      rounded-lg  hover:bg-transparent hover:text-yellow-400 md:text-[22px]'>Subscribe</button>   
</div>
