...
<h1 className=' md:mb-4 font-bold text-3xl'>Looking For Experts?</h1>
<h2 className='text-xl'>Are you looking for skilled web professionals to elevate your online presence? Look no further! We connect businesses with a
   ...
   <h1 className='md:mb-3 md:mt-3 font-bold text-2xl'>Why Choose Us?</h1>
    ...
    <div  className=' w-90 flex flex-col md:flex-row mt-10 mb-10'>
       ...
       <Image src={e3} alt="" width={500} height={500} className='w-[400px] h-[280px] '></Image>
        <div className='w-[346px] h-[196px] bg-teal-800 text-white'>
         <h1 className='text-lg font-semibold'>Martin Anderson</h1>
         <h2><b>Web Developer</b></h2>
         <p>Proficiency in both front-end and back-end development to build seamless applications 
       ...
       <Image src={e2} alt="" width={500} height={500} className='w-[400px] h-[280px] '></Image>
        <div className='w-[346px] h-[196px] bg-teal-800 text-white '>
        <h1 className='text-lg font-semibold'>Semanta Klores</h1>
        <h2><b>Web Designer</b></h2>
         <p>My expertise in Adobe Creative Suite allows me to deliver innovative solutions across both digital
       ...
       <Image src={e1} alt="" width={500} height={500} className='w-[400px] h-[280px] '></Image>
        <div className='w-[346px] h-[196px] bg-teal-800 text-white p-3 '>
        <h1 className='text-lg font-semibold'>Rayan Khan</h1>
         <h2><b>SEO Expert</b></h2>
         <p>My approach involves comprehensive keyword research, on-page optimization ,  and strategic link-building
    ...
    <button className='flex justify-center bg-yellow-400 text-white p-3 mt-20 mb-20  m-auto border-2 border-yellow-400 w-56 md:w-[300px] 
